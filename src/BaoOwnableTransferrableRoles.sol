...
abstract contract BaoOwnableTransferrableRoles is BaoOwnableTransferrable, BaoRoles {
    function supportsInterface(
        bytes4 interfaceId
    ) public view virtual override(BaoOwnableTransferrable, BaoRolesCore) returns (bool) {
        return BaoOwnableTransferrable.supportsInterface(interfaceId) || BaoRolesCore.supportsInterface(interfaceId);
    }
}
