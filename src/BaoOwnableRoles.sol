...
/// @author rootminus0x1
abstract contract BaoOwnableRoles is BaoOwnable, IBaoOwnableRoles {
    ...
    function supportsInterface(bytes4 interfaceId) public view virtual override(BaoOwnable) returns (bool) {
        return interfaceId == type(IBaoOwnableRoles).interfaceId || BaoOwnable.supportsInterface(interfaceId);
    }
