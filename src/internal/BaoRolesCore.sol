...
abstract contract BaoRolesCore is IBaoRoles, ERC165 {
    ...
    /// @dev Returns whether `user` should be treated as the owner.
    function _isOwner(address user) internal view virtual returns (bool);
    ...
    function _checkRolesOrOwner(uint256 roles) internal view virtual {
        // Check roles first.
        // If roles check fails, allow owner as a fallback.
        // This matches the existing semantics: roles-or-owner.
        if (hasAnyRole(msg.sender, roles)) return;
        _requireOwner();
    }
